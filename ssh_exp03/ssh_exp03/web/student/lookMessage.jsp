<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.ArrayList,cn.cslg.main.StudentBean"%>
    ...
    <body>
        ...
        <table align="center" width="80%">
            <tr>
                ...
                <td width="25%">
                    <s:a href="http://localhost:8080/sshExp3/student/findMessage.jsp">修改学生信息</s:a>
                </td>
                <td width="25%">
